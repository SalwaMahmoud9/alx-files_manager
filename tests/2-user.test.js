...
describe('User Endpoints', () => {
  ...
  // users
  describe('POST /users', () => {
    it('return the id and email', async () => {
    ...
    it('fail because password missing', async () => {
      const user = {
        email: 'bob@dylan.com',
      };
      const response = await request(app).post('/users').send(user);
    ...
    it('fail because email missing', async () => {
      const user = {
        password: 'toto1234!',
      };
      const response = await request(app).post('/users').send(user);
    ...
    it('fail because it already exist', async () => {
      const user = {
        email: 'bob@dylan.com',
        password: 'toto1234!',
      };
  ...
  describe('GET /disconnect', () => {
    ...
    it('responde with unauthorized', async () => {
